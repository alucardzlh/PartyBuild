...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = Application.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = Application.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
