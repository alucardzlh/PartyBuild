...
//                Request.add("PageSize", 10);
    ...
    public void showinit() {
        et = new EditText(DetailsPageActivity2.this);
//        et.setPadding(20,50,0,0);
        new AlertDialog.Builder(DetailsPageActivity2.this)
                .setTitle("评论")
                .setView(et)
                .setPositiveButton("确认", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(!TextUtils.isEmpty(et.getText())){
                            ...
                            CallServer.getInstance().add(DetailsPageActivity2.this, Request, GsonCallBack.getInstance(), 0x0071, true, false, true);
                        }else{
                            Toast.show("评论内容不能为空!!!");
                        }
